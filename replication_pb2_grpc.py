...
class ReplicationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReplicateUpdate = channel.unary_unary(
                '/replication.ReplicationService/ReplicateUpdate',
                request_serializer=replication__pb2.ReplicationUpdateRequest.SerializeToString,
                response_deserializer=replication__pb2.ReplicationUpdateResponse.FromString,
...
def add_ReplicationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ReplicateUpdate': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=replication__pb2.ReplicationUpdateRequest.FromString,
                    response_serializer=replication__pb2.ReplicationUpdateResponse.SerializeToString,
            ),
    }
...
class ReplicationService(object):
    ...
    def ReplicateUpdate(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/replication.ReplicationService/ReplicateUpdate',
            replication__pb2.ReplicationUpdateRequest.SerializeToString,
            replication__pb2.ReplicationUpdateResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
